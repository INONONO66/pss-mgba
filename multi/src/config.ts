...
const ConfigSchema = z.object({
  ...
  maxInstances: z.coerce.number().default(10),
  emulatorImage: z.string().default('pss-mgba-emulator'),
  emulatorPort: z.coerce.number().default(8888),
  captureIntervalMs: z.coerce.number().default(100),
  jpegQuality: z.coerce.number().default(60),
  wsBackpressureLimit: z.coerce.number().default(262_144),
