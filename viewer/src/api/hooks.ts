...
import type { EventsResponse, GameStateResponse, LlmConversationsResponse, RunSummary } from "./types";
...
export function useLlmConversations(limit = 20) { return usePolling<LlmConversationsResponse>(`/api/llm-conversations?limit=${limit}`, 1000).data; }
